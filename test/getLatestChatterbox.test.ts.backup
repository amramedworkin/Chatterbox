...
async function main(): Promise<void> {
    ...
    try {
        ...
        if (latestEmail) {
            ...
            console.log(chalk.yellow('📅 Sent Date:'), chalk.white(getEmailSentDateString(fullEmail)));
            console.log(chalk.yellow('📅 Received Date:'), chalk.white(getEmailReceivedDateString(fullEmail)));
            console.log(chalk.yellow('📝 Subject:'), chalk.white(latestEmail.subject || 'No subject'));
            console.log(chalk.yellow('👤 From:'), chalk.white(latestEmail.sender || 'No sender'));
            console.log(chalk.yellow('💬 Snippet:'), chalk.white(latestEmail.snippet || 'No snippet'));
        } else {
