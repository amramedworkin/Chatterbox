...
try {
  const awsIdentity = execSync('aws sts get-caller-identity --profile cliadmin', { encoding: 'utf8' });
...
if (allPassed) {
  console.log(chalk.green('🎉 All prerequisites are met! You can proceed with AWS infrastructure setup.'));
  ...
  console.log(chalk.red('❌ Some prerequisites are missing. Please install and configure them before proceeding.'));
  console.log(chalk.blue('\nInstallation guides:'));
